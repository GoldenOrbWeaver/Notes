...
We then do sensitivity analysis on this to find \(S(t,c)\): \\
\[
    S(t,c)=\frac{c}{t}\frac{dt}{dc}\big| _{t=19.4815944416122, c=\frac{1}{40}}
\]

We found that \\
\[
    \frac{dP}{dt}=-0.45-2*e^{ct}+200c*(0.65-0.01t)*e^{c*t}
\]

We try to use implicit differentiation and set this equal to \(u(t,c)=0\): \\
\begin{align}
    \frac{d}{dc}u(t,c)&=\frac{\partial u}{\partial t}\frac{dt}{dc}+\frac{\partial u}{\partial c}=0 \\
    \Rightarrow \frac{dt}{dc}=\frac{-\frac{\partial u}{\partial c}}{\frac{\partial u}{t}}
\end{align}
...
\begin{eg}
    ...
    with a new facility. The old station was located at the historical city center.
    City planners intend to locate the new facility more scientifically. A statistical
    analysis of response–time data yielded an estimate of \(3.2 + 1.7r^{0.91}\)  minutes
    required to respond to a call r miles away from the station. (The derivation of
    this formula is the subject of Exercises 17 and 18 in Chapter 8.) Estimates of
    ...
    \includegraphics[width=0.7\linewidth]{MATH420_image12.png}
\end{eg}
...
\textbf{FINISH CALCULATIONS FOR 3.2}
